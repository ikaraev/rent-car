...
use Karaev\Booking\Domain\Models\BookingContactForm as Domain;
use Karaev\Booking\Infrastructure\Eloquent\Model\BookingContactForm as Entity;

class BookingContactFormTransformer
{
    /**
     * @param Entity $entity
     * @return Domain
